...
class Team(db.Model):
    ...
    def __init__(self, team_name, starred_position):
        self.team_name = team_name
        self.starred_position = starred_position

    def __repr__(self):
        return "<Team(team_name='%s', qb1='%s', qb2='%s', wr1='%s', wr2='%s', wr3='%s', rb1='%s', \
            rb2='%d', rb3='%s', starred_position='%s')>" \
               % (self.team_name, self.qb1, self.qb2, self.wr1, self.wr2, self.wr3, self.rb1, 
